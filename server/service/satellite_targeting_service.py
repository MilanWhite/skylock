...
class ISatelliteTargetingService(abc.ABC):
    ...
    def get_targeting_info(self,
                          ...
                          ground_alt: float,
                          satellite_ecef: List[float],
                          current_azimuth_deg: Optional[float] = None,
                          current_elevation_deg: Optional[float] = None,
                          current_range_km: Optional[float] = None) -> Dict[str, Any]:
        """
...
class SatelliteTargetingService(ISatelliteTargetingService):
    ...
    def _ecef_to_enu(self,
                     ecef_vector: List[float],
                     lat_deg: float,
                     lon_deg: float) -> List[float]:
